...
public class Cartao implements Serializable {
    ...
    public void creditar(double valorCredito) {
        if (valorCredito < VALOR_MINIMO_DEPOSITO) {
            throw new IllegalArgumentException(String.format("Valor de depósito não pode ser menor que %.2f", VALOR_MINIMO_DEPOSITO));
        }

        saldo += valorCredito - TARIFA_DEPOSITO;
    }
}
