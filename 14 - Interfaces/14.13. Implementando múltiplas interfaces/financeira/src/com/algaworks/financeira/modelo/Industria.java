...
public class Industria extends EmpresaFinancial {

    public static final double PERCENTUAL_FATURAMENTO_LIMITE_CREDITO = 0.5;
    public static final double TAXA_DE_ACRESCIMO_LIMITE_INDUSTRIA_SUSTENTAVEL = 1.2;
    ...
    public double calcularLimiteAprovado() {
        ...
        if (isCompensaEmissaoCo2()) {
            valorAprovado *= TAXA_DE_ACRESCIMO_LIMITE_INDUSTRIA_SUSTENTAVEL;
        }
